...
public class DiaryMain extends JFrame{
	...
	public DiaryMain() {
		...
		bt_prev=new JButton("◀");
		bt_next=new JButton("▶");
		la_title=new JLabel("1994-05-27");
		...
		//setBounds로 좌표에 의한 위치를 설정할 경우, 컨테이너엔 레이아웃, 배치관리자가 적용되지 말아야 한다.
		p_west.setLayout(null); //적용 안함
		...
		//간단한 함수 기반으로 작성하는 방법
		//-> 람다 표현식 (Lambda) - 함수 기반 언어에서 유래
		//거창하게 객체까지 필요없는 단순한 코드인 경우 함수 수준으로 처리하는 게 코드량이 더 적다.
